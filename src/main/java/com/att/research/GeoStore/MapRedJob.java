...
public class MapRedJob {
  ...
  public void currentInputPaths() throws FileNotFoundException, IOException {
    ...
    String outputLocation = "/projects/locstore/log/input/" + dt + "/inputFiles.txt";
  ...
  protected void initHadoopJob(Class<? extends Mapper> mapper, Class<? extends Reducer> reducer,
